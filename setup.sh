...
echo "  - Auto-compact threshold lowered to 60% (was 80%) — proactive context management"
echo "  - For each project, copy the .claudeignore template to reduce token waste:"
